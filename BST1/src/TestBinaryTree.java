...
public class TestBinaryTree {
	...
	public static void main(String[] args) {
		...
		//(recursive)print pre-order - fully abstracted
		System.out.println("Pre Order\t:"+bt.printPreOrder());
				
		//(recursive)print pre-order - via getting root node		
		System.out.println("Pre Order\t:"+bt.printPreOrder(node));

		//(recursive)print post-order - fully abstracted
		System.out.println("Post Order\t:"+bt.printPostOrder());
						
		//(recursive)print post-order - via getting root node		
		...
		System.out.println();
		System.out.println("Leaves\t: "+bt.showLeaves(node));
